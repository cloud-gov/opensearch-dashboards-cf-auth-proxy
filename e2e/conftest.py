...
def user_1():
    ...
    user_1 = User(user_1_username, user_1_password, user_1_totp_seed, user_1_space_id, user_1_org_id)
    return user_1
...
def user_2():
    ...
    user_2 = User(user_2_username, user_2_password, user_2_totp_seed, user_2_space_id, user_2_org_id)
    return user_2
