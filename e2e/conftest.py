...
def user_1():
    ...
    user_1_space_id = getenv(f"TEST_USER_1_SPACE_ID")
    user_1_org_id = getenv(f"TEST_USER_1_ORG_ID")
    user_1 = User(
        user_1_username,
        user_1_password,
        user_1_totp_seed,
...
def user_2():
    ...
    user_2_space_id = getenv(f"TEST_USER_2_SPACE_ID")
    user_2_org_id = getenv(f"TEST_USER_2_ORG_ID")
    user_2 = User(
        user_2_username,
        user_2_password,
        user_2_totp_seed,
