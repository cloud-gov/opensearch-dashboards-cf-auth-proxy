...
def test_gets_cf_user_all_orgs():
    with requests_mock.Mocker() as m:
        response_1 = """
  {
   "pagination": {
      ...
      "last": {
         "href": "http://mock.cf/v3/roles?order_by=%2Bcreated_at&page=2&per_page=1&types=organization_user&user_guids=a-user-guid"
      },
      "next": {
         "href": "http://mock.cf/v3/roles?order_by=%2Bcreated_at&page=2&per_page=1&types=organization_user&user_guids=a-user-guid"
      },
        ...
        response_2 = """
  {
   ...
   "resources": [
    ...
    """
        ...
        m.get(
            "http://mock.cf/v3/roles?order_by=%2Bcreated_at&page=2&per_page=1&types=organization_user&user_guids=a-user-guid",
            text=response_2,
        )
        assert sorted(cf.get_all_orgs_for_user("a-user-id", "a_token")) == sorted(
